...
tellraw @s[tag=gui_maker.remove_display_tag] "Sol eldeki öğenin display etiketi silindi"
tellraw @s[tag=!gui_maker.remove_display_tag] "Sol eldeki öğeye display etiketi eklendi"
