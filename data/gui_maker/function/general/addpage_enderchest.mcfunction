...
# 追加内容の表示
tellraw @a "Yeni bir GUI sayfası eklendi"

tellraw @a ["Sayfa Numarası: ",{"nbt":"tmp.general/addpage_enderchest.newpage.id","storage":"gui_maker:"},"  Etiket: ",{"nbt":"tmp.general/addpage_enderchest.newpage.tag","storage":"gui_maker:"}]
